...
namespace Translator
{
    ...
    class Word
    {
        ...
        /* public string DefinitionWord(string textword)
         {
             if (textword == null) return null; // В случае если нет слова
             int RuCount = 0;
             int EngCount = 0;
    ...
    class EngWord : Word
    {
        public string EngTextword { get; set; }  // английское слово
        public List<string> RelatedWords { get; set; } // связанные слова

        public EngWord(string textword = null, string engtextword = null) : base(textword)
        {
            this.EngTextword = engtextword;
            this.RelatedWords = new List<string>();
        }

    }
    class RusWord : Word
    {
        public string RusTextword { get; set; }  // Перевод
        public List<string> RelatedWords { get; set; } // связанные слова

        public RusWord(string textword = null, string rustextword = null) : base(textword)
        {
            this.RusTextword = rustextword;
            this.RelatedWords = new List<string>();
        }
    ...
    class Program
    {
        ...
        static void AddWordTranslator()
        {
            ...
            //++++++++++++++++++++++++++++++++++++++++++++++++++++
            if (RusOrEng(AddWord) == "Rus")
            {

                Console.Write($"{AddWord} - ");
                string EngAddWord = Console.ReadLine();

                RusWord rusWord = new RusWord(AddWord, EngAddWord);
               
                while (true)
                {
                    Console.Write("Добавить еще слова к переводу? (Y/N) ");
                    ...
                    if (YN == ConsoleKey.Y)
                    {
                        ...
                        rusWord.RelatedWords.Add(AddOtherWord);
            ...
            if (RusOrEng(AddWord) == "Eng")
            {

                Console.Write($"{AddWord} - ");
                string RusAddWord = Console.ReadLine();

                EngWord engWord = new EngWord(AddWord, RusAddWord);
                //List<string> OtherWord = new List<string>(); // Другие
                ...
                while (true)
                {
                    ...
                    if (YN == ConsoleKey.Y)
                    {
                        Console.Write($"{AddWord} - {RusAddWord} - ");
                        string AddOtherWord = Console.ReadLine();
                        engWord.RelatedWords.Add(AddOtherWord);
...
/*
            ...
            static void Main(string[] args)
            {
                ...
                engWords.Add(new EngWord("asdas","asdas"));
                */
